    ...
    return (
        <>
            <div className="w-full">
                ...
                <div className="flex items-center w-full justify-center pt-0 pb-10">
                    <h1 className="text-white text-sm">Cart</h1>
                    <hr className="h-0 mx-5 w-32" />
                    <h1 className="text-white text-sm">Address</h1>
                    <hr className="h-1 mx-5 w-32" />
                    <h1 className="text-white text-sm">Payment</h1>
                    <hr className="h-1 mx-5 w-32" />
                    <h1 className="text-white text-sm">Order Successfully</h1>
                </div>
